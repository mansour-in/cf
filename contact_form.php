...
// configure
$from = 'no-replay@mansour.in'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'mail@mansour.in'; // Replace it with Your email. REQUIRED!
$subject = 'New message from Mansour.in form';
